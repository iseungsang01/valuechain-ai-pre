...
class EstimatorAgent(BaseAgent):
    ...
    def _llm_generate_graph(
        ...
        prompt = (
            ...
            "Instead, you MUST ESTIMATE a reasonable non-zero value based on logical inference (e.g. Estimated Revenue = Q * P).\n"
            "CRITICAL ESTIMATION RULE FOR P AND Q:\n"
            ...
            "  2. Estimating P (ASP): Project the current ASP based on historical ASP trends found in the sources or broader industry logic.\n"
            "  3. Estimating Q (Volume): Project the current volume based on the 3-year historical volume movement/CAGR found in the sources.\n"
